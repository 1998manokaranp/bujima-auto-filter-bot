...
@Client.on_message(filters.user(ADMINS) & filters.command("sh") & filters.private)
def sh(_, m: Message):
        try:
...
@Client.on_message(filters.user(ADMINS) & filters.command(["eval","bash","run", "e"]))
...
@Client.on_message(filters.command("linklogs") & filters.user(ADMINS))
