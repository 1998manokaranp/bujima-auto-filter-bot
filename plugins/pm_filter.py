     ...
     #   if not search:
      ...
      #      return
        ...
        buttons = [[ 
             ...
             InlineKeyboardButton('ᴛᴇʟᴇɢʀᴀᴘʜ', callback_data='telex') 
         ], [ 
             InlineKeyboardButton('ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ', callback_data='coct'), 
             InlineKeyboardButton('ꜰɪʟᴛᴇʀꜱ', callback_data='filters')
         ], [
             InlineKeyboardButton('ʏᴛ-ᴅʟ', callback_data='ytdlx'), 
             InlineKeyboardButton('ꜱʜᴀʀᴇ ᴛᴇxᴛ', callback_data='sharex')
         ], [
             InlineKeyboardButton('ꜱᴏɴɢ', callback_data='songx'),
             InlineKeyboardButton('ᴊ-ꜱᴏɴ', callback_data='jsonx')
         ], [
             InlineKeyboardButton('ꜱᴛɪᴄᴋᴇʀ-ɪᴅ', callback_data='stickerx'),
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 📜', url='https://t.me/Mobarak46'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def help_menu(client, message):
    buttons = [
        [InlineKeyboardButton("RENAME/MODE", callback_data="rename"),
         InlineKeyboardButton("STREAM/MODE", callback_data="stream")],
    ...
    await message.reply_text(
        "**📖 Help Menu - Choose a Feature Below**",
        reply_markup=InlineKeyboardMarkup(buttons)
    )

@Client.on_callback_query(filters.regex("^rename$"))
async def rename_help(client, query):
    await query.message.edit_text("🔁 This feature lets you rename your files or change modes.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^stream$"))
async def stream_help(client, query):
    await query.message.edit_text("📺 Stream files without downloading.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^filestore$"))
async def filestore_help(client, query):
    await query.message.edit_text("📂 Access all your saved files here.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^telegraph$"))
async def telegraph_help(client, query):
    await query.message.edit_text("📰 Use Telegraph to post text/images.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^connections$"))
async def connections_help(client, query):
    await query.message.edit_text("🔗 Manage group connections.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^filters$"))
async def filters_help(client, query):
    await query.message.edit_text("🔍 Use filters to auto respond to keywords.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^ytdl$"))
async def ytdl_help(client, query):
    await query.message.edit_text("📥 Download YouTube videos/audio.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^sharetext$"))
async def sharetext_help(client, query):
    await query.message.edit_text("🔤 Share text quickly via the bot.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^song$"))
async def song_help(client, query):
    await query.message.edit_text("🎶 Download songs by name.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^json$"))
async def json_help(client, query):
    await query.message.edit_text("🧾 Get JSON data of messages.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^stickerid$"))
async def stickerid_help(client, query):
    await query.message.edit_text("🆔 Get the ID of any sticker.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^admin$"))
async def admin_help(client, query):
    await query.message.edit_text("👮 Admin-only tools and stats.",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅ Back to Help", callback_data="show_help_menu")]]))
    await query.answer()

@Client.on_callback_query(filters.regex("^show_help_menu$"))
async def show_help_menu(client, query):
...
async def back_to_start(client, query):
    await query.message.delete()
    await client.send_message(query.message.chat.id, "👋 Back to start menu! Use /start to begin again.")
    await query.answer()
