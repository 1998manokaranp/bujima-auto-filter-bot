...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    elif query.data == "yt_dl":
        await query.message.edit_text(
            text="🎬 𝗬𝗼𝘂𝗧𝘂𝗯𝗲 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗿

Send a YouTube URL and I will download it.",
        ...
        await query.message.edit_text(
            text="🖼️ 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗽𝗵 𝗨𝗽𝗹𝗼𝗮𝗱

Reply to a media message and use /telegraph to upload to telegra.ph.",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Back", callback_data="help")],
            ])
        )
...
Reply to any sticker and use /stickerid to get its ID.",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Back", callback_data="help")],
            ])
        )
...
Use /share followed by your text to get a shareable link.",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Back", callback_data="help")],
            ])
        )
...
Reply to a message and use /json to view the raw Telegram message JSON.",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Back", callback_data="help")],
            ])
        )
        ...
        await query.message.edit_text(
            text="🎵 𝗦𝗼𝗻𝗴 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗿

Use /song [song name] to download songs from YouTube.",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Back", callback_data="help")],
            ])
        )
